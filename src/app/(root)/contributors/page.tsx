    ...
    <>
      <div className="lg:h-full w-full space-y-4 mt-2">
        ...
        <div className="space-y-4">
          {/* table header */}
          <div className="flex justify-between items-center py-3 bg-zinc-100 w-full grid grid-cols-12 text-xs md:text-sm lg:text-lg tracking-widest text-blue uppercase">
            <div className="col-span-2 lg:col-span-1 border-r border-r-[1px] border-blue text-center">RANK</div>
            <div className="col-span-6 lg:col-span-5 border-r border-r-[1px] border-blue flex justify-center lg:justify-end">
          ...
          <div className="relative w-full ">
            <div className="absolute left-2/3 top-8 hidden lg:block">
              <Image src="/assets/blocks/medium-1.webp" alt="green blocks" width={150} height={54} priority />
            </div>
            <div className="absolute left-24 top-1/2 hidden lg:block">
              <Image src="/assets/blocks/medium-2.webp" alt="green blocks" width={75} height={54} priority />
            </div>
            <div className="absolute right-1/2 top-3/4 px-4 hidden lg:block">
              <Image src="/assets/blocks/medium-3.webp" alt="green blocks" width={75} height={54} priority />
            </div>
            <div className="bg-zinc-100 text-sm lg:text-lg tracking-widest px-1 py-4 overflow-y-auto" style={{ maxHeight: "calc(100vh - 196px)" }}>
              {contributors.map((contributor, index) => {
                ...
                return (
                  <div className="relative" key={index}>
                    {tierLabel && <div className="absolute top-0 left-0 -mt-2 text-xs w-fit px-1 bg-zinc-100 text-blue">{tierLabel}</div>}
                    <div className="grid grid-cols-12 py-4 border-t-[0.5px] border-slate-400">
