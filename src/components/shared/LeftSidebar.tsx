  ...
  return (
    <section className="hidden lg:block custom-scrollbar sticky left-0 top-0 flex h-screen flex-col justify-between overflow-y-auto shadow-light-300 dark:shadow-none max-sm:hidden lg:w-[308px] px-4 py-8">
      <div className="flex flex-col justify-between h-full">
        ...
        <div>
          <Link href="/">
            <Image src="/assets/brand/OurNetwork.webp" alt="OurNetwork" width={288} height={80} priority />
          </Link>
          <div className="pt-8 pb-4 mb-4 px-4 space-y-2 border-b-[2px]">
            ...
            {pathname === "/" && (
              <div className="mt-3 flex mb-3 align-center rounded-xl bg-zinc-50 p-2 w-full max-w-xl font-sans">
                ...
                <input type="text" placeholder="Search" className="px-2 relative bg-zinc-50 rounded text-md w-full focus:outline-none" onChange={handleSearch} />
              </div>
            )}
          </div>
